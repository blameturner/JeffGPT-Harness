...
from app.routers import agents, chat, code, health, stats, tool_queue, enrichment, planned_search
...
app.include_router(planned_search.router, prefix="/planned_search", tags=["planned_search"])
