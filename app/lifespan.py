...
async def lifespan(app: FastAPI):
    ...
    from workers.tool_queue import (
        ...
        _handle_graph_extract, _handle_deep_search, _handle_research,
        _set_instance,
    )
    ...
    tool_queue.register("deep_search", HandlerConfig(
        handler=_handle_deep_search, max_workers=1, priority_default=2,
    ))
